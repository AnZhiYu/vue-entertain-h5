<template>
  <div class="page transaction">
    ...
    <common-title title="交易大厅" />
    <!-- <div class="transaction-title">
      交易大厅
      <div class="transaction-title-now">
          ...
          <van-tab title="卖方单">
            <div class="item">
              <div class="item-header">
                <span class="item-header_type" v-show="isShowTime">时间</span>
                <span class="item-header_type">订单号</span>
                <span class="item-header_type">用户ID</span>
                <span class="item-header_type">YUAN</span>
                <span class="item-header_type" :style="{ width: '15%' }">操作</span>
              </div>
              <van-list
                v-model="loading"
                :finished="finished"
                ...
                immediate-check
              >
                <transaction-item :itemList="itemList1"></transaction-item>
              </van-list>
            </div>
          </van-tab>
          <van-tab title="买方单">
            <div class="item">
              ...
              <van-list
                ...
                immediate-check
              >
                <transaction-item :itemList="itemList2"></transaction-item>
              </van-list>
            </div>
          </van-tab>
          <van-tab title="我的订单">
            <div class="item">
              <div class="item-header">
                <span class="item-header_type">时间</span>
                <!-- <span class="item-header_type order">订单号</span> -->
                <span class="item-header_type buyer">买家</span>
                <span class="item-header_type seller">卖家</span>
                <span class="item-header_type">YUAN</span>
                <span class="item-header_type status">状态</span>
                <span class="item-header_type" :style="{ width: '20%' }">操作</span>
              </div>
              <van-list
                v-model="loading"
                :finished="finished"
                finished-text="没有更多了"
                immediate-check
                @load="SearchMyOrderList"
              >
                <my-order-item
                  :itemList="itemList3"
                  @cancelPendingOrder="showOverlay"
                ></my-order-item>
              </van-list>
            </div>
          </van-tab>
          <van-tab title="我的挂单">
            <div class="item">
              <div class="item-header">
                <span class="item-header_type">时间</span>
                <span class="item-header_type">订单号</span>
                <span class="item-header_type">YUAN 钱包</span>
                <span class="item-header_type">状态</span>
                <span class="item-header_type" :style="{ width: '20%' }">操作</span>
              </div>
              <van-list
                v-model="loading"
                ...
                finished-text="没有更多了"
                immediate-check
                @load="SearchMyPendingOrderList"
              >
                <my-pendding-order-item
                  :itemList="itemList4"
                  @cancelPendingOrder="showOverlay"
                ></my-pendding-order-item>
              </van-list>
    ...
    <drage>
      <div class="transaction-fixed" @click="selectTrade">我要交易</div>
    </drage>
    <bottom-tab-bar :defaultActive="1" />
  </div>
</template>
